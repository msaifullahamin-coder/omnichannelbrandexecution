...
// 🔥 PERBAIKAN: Ditambah dueDate (Tanggal Jatuh Tempo) dan assignees (Daftar Penugasan)
export const initialTasks = [
  { id: 't8', title: 'Setup Akun IG & TikTok + Optimasi Bio', phase: 'Phase 1', status: 'done', priority: 'high', pic: 'Ghina', assignees: ['Ghina'], avatar: 'https://i.pravatar.cc/150?img=9', targetPersonas: ['All Personas'], budget: 1000000, realisasi: 0, dueDate: '2026-05-02' },
  { id: 't9', title: 'Desain Logo & Omnichannel Brand Guideline', phase: 'Phase 1', status: 'done', priority: 'high', pic: 'Azka', assignees: ['Azka'], avatar: 'https://i.pravatar.cc/150?img=5', targetPersonas: ['All Personas'], budget: 2000000, realisasi: 0, dueDate: '2026-05-04' },
  { id: 't6', title: 'Create 2000 Persona Accounts Data', phase: 'Phase 2', status: 'done', priority: 'low', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 1500000, realisasi: 0, dueDate: '2026-05-06' },
  { id: 't10', title: 'Mapping Competitor Ads (TikTok & Meta Library)', phase: 'Phase 2', status: 'done', priority: 'medium', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['All Personas'], budget: 500000, realisasi: 0, dueDate: '2026-05-08' },
  { id: 't1', title: 'Setup Meta Business Manager & Ad Account', phase: 'Phase 3', status: 'done', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 1000000, realisasi: 0, dueDate: '2026-05-09' },
  { id: 't11', title: 'Setup TikTok Business Center & Pixel', phase: 'Phase 3', status: 'done', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 1000000, realisasi: 0, dueDate: '2026-05-10' },
  
  // 🚨 TASK NUNGGAK (Tanggal Masa Lalu, Status Belum Selesai)
  { id: 't5', title: 'Setup Google Analytics 4 & Tag Manager', phase: 'Phase 3', status: 'doing', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 500000, realisasi: 0, dueDate: '2026-05-12' },
  { id: 't4', title: 'Launch Meta Ads (Edukasi vs Hard Selling)', phase: 'Phase 6', status: 'todo', priority: 'high', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['Fatimah Az-Zahra', 'Aisyah Putri'], budget: 5000000, realisasi: 0, dueDate: '2026-05-13' },
  { id: 't2', title: 'Design Landing Page UI (Aesthetic Islamic)', phase: 'Phase 5', status: 'review', priority: 'high', pic: 'Azka', assignees: ['Azka'], avatar: 'https://i.pravatar.cc/150?img=5', targetPersonas: ['Aisyah Putri', 'Budi Santoso'], budget: 2500000, realisasi: 0, dueDate: '2026-05-14' },
  
  // 📅 TASK HARI INI & MASA DEPAN
  { id: 't12', title: 'Bikin Script Video Hook Emosional (Storytelling)', phase: 'Phase 4', status: 'todo', priority: 'high', pic: 'Ghina', assignees: ['Ghina'], avatar: 'https://i.pravatar.cc/150?img=9', targetPersonas: ['Fatimah Az-Zahra', 'Aisyah Putri'], budget: 2000000, realisasi: 0, dueDate: '2026-05-16' },
  { id: 't17', title: 'Launch Omnichannel Retargeting (Diskon 10%)', phase: 'Phase 6', status: 'todo', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 3000000, realisasi: 0, dueDate: '2026-05-18' },
  { id: 't15', title: 'Copywriting Headline Landing Page', phase: 'Phase 5', status: 'review', priority: 'high', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['All Personas'], budget: 1000000, realisasi: 0, dueDate: '2026-05-15' },
  { id: 't14', title: 'Integrasi Pixel (Meta, TikTok, Google) di LP', phase: 'Phase 5', status: 'review', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 500000, realisasi: 0, dueDate: '2026-05-17' },
  { id: 't3', title: 'Shoot Video Vertikal (Reels/TikTok) - Tajwid Dasar', phase: 'Phase 4', status: 'review', priority: 'medium', pic: 'Ghina', assignees: ['Ghina'], avatar: 'https://i.pravatar.cc/150?img=9', targetPersonas: ['Nisa Sabyan (Lookalike)'], budget: 4000000, realisasi: 0, dueDate: '2026-05-19' },
  { id: 't7', title: 'Launch TikTok Ads (Video Conversion Campaign)', phase: 'Phase 6', status: 'review', priority: 'medium', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['Nisa Sabyan (Lookalike)'], budget: 4500000, realisasi: 0, dueDate: '2026-05-21' },
  { id: 't13', title: 'Desain Carousel IG & Banner Marketplace', phase: 'Phase 4', status: 'todo', priority: 'medium', pic: 'Azka', assignees: ['Azka'], avatar: 'https://i.pravatar.cc/150?img=5', targetPersonas: ['Nisa Sabyan (Lookalike)', 'Budi Santoso'], budget: 1500000, realisasi: 0, dueDate: '2026-05-22' },
  { id: 't16', title: 'Setup Google Search Ads (Keyword: Belajar Tajwid)', phase: 'Phase 6', status: 'todo', priority: 'medium', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['Budi Santoso'], budget: 2000000, realisasi: 0, dueDate: '2026-05-24' },
  { id: 't18', title: 'Setup Shopee Ads (Iklan Pencarian & Toko)', phase: 'Phase 7', status: 'todo', priority: 'low', pic: 'Azka', assignees: ['Azka'], avatar: 'https://i.pravatar.cc/150?img=5', targetPersonas: ['All Personas'], budget: 1000000, realisasi: 0, dueDate: '2026-05-25' },
  { id: 't19', title: 'Broadcast Promo Follow-up via WhatsApp API', phase: 'Phase 7', status: 'todo', priority: 'medium', pic: 'Ghina', assignees: ['Ghina'], avatar: 'https://i.pravatar.cc/150?img=9', targetPersonas: ['Fatimah Az-Zahra'], budget: 500000, realisasi: 0, dueDate: '2026-05-27' },
  { id: 't20', title: 'Weekly Cross-Platform Review: Matikan Ads Boncos', phase: 'Phase 8', status: 'doing', priority: 'high', pic: 'Saifull', assignees: ['Saifull'], avatar: 'https://i.pravatar.cc/150?img=11', targetPersonas: ['All Personas'], budget: 0, realisasi: 0, dueDate: '2026-05-15' },
  { id: 't21', title: 'Analisa Attribution Model (Platform mana yang menang?)', phase: 'Phase 8', status: 'todo', priority: 'medium', pic: 'Bagas', assignees: ['Bagas'], avatar: 'https://i.pravatar.cc/150?img=12', targetPersonas: ['All Personas'], budget: 0, realisasi: 0, dueDate: '2026-05-28' },
];
